...
class links_page_cat_ui extends e_admin_ui
{
		...
		protected $eventName		= 'links_page-links_page_cat'; 	
...
class links_page_ui extends e_admin_ui
{
		...
		protected $pluginTitle	= LCLAN_PLUGIN_LAN_1;
		protected $pluginName		= 'links_page';
		protected $eventName		= 'links_page-links_page'; 		
		protected $table			= 'links_page';
		protected $pid				= 'link_id';
		protected $perPage			= 10; 
		protected $batchDelete		= true;
	 	protected $batchCopy		= true;
		protected $listQry      	= "SELECT * FROM `#links_page` WHERE link_active != '0' ";	
      ...
      'options' =>   array ( 'title' => LAN_OPTIONS, 'type' => null, 'data' => null, 'width' => '10%', 'thclass' => 'center last', 'class' => 'center last', 'forced' => '1',  ),
		...
		protected $prefs = array(
			'link_page_categories'		=> array('title'=> LCLAN_OPT_7, 'tab'=>0, 'type'=>'boolean', 'data' => 'str', 'help'=>''),
			'link_submit'		=> array('title'=> LCLAN_OPT_8, 'tab'=>0, 'type'=>'boolean', 'data' => 'str', 'help'=>''),
			'link_submit_class'		=> array('title'=> LCLAN_OPT_9, 'tab'=>0, 'type'=>'userclass', 'data' => 'str', 'help'=>''),
			'link_submit_directpost'		=> array('title'=> LCLAN_OPT_48, 'tab'=>0, 'type'=>'boolean', 'data' => 'str', 'help'=>LCLAN_HELP_1),
			//link_nextprev
      'link_nextprev'		=> array('title'=> LCLAN_OPT_10, 'tab'=>0, 'type'=>'boolean', 'data' => 'str', 'help'=>''),
			//link_nextprev_number
      'link_nextprev_number'		=> array('title'=> LCLAN_OPT_11, 'tab'=>0, 'type'=>'number', 'data' => 'str', 'help'=>''),
			//link_comment
      'link_comment'		=> array('title'=> LCLAN_OPT_55, 'tab'=>0, 'type'=>'boolean', 'data' => 'str', 'help'=>''),
      ...
      'link_navigator_frontpage'	=> array('title'=> LCLAN_OPT_60, 'tab'=>1, 'type'=>'boolean', 'data' => 'str', 'help'=>''),
      'link_navigator_submit'		  => array('title'=> LCLAN_OPT_58, 'tab'=>1, 'type'=>'boolean', 'data' => 'str', 'help'=>''),
      'link_navigator_manager'		=> array('title'=> LCLAN_OPT_59, 'tab'=>1, 'type'=>'boolean', 'data' => 'str', 'help'=>''),
      'link_navigator_refer'		=> array('title'=> LCLAN_OPT_20, 'tab'=>1, 'type'=>'boolean', 'data' => 'str', 'help'=>''),
      'link_navigator_rated'		=> array('title'=> LCLAN_OPT_21, 'tab'=>1, 'type'=>'boolean', 'data' => 'str', 'help'=>''),
      'link_navigator_links'		=> array('title'=> LCLAN_OPT_67, 'tab'=>1, 'type'=>'boolean', 'data' => 'str', 'help'=>''),
      'link_navigator_category'		=> array('title'=> LCLAN_OPT_61, 'tab'=>1, 'type'=>'boolean', 'data' => 'str', 'help'=>''),      

      
      'link_manager'		=> array('title'=> LCLAN_OPT_54, 'tab'=>2, 'type'=>'boolean', 'data' => 'str', 'help'=>''),        
      ...
      'link_cat_icon'		=> array('title'=> LCLAN_OPT_14, 'tab'=>3, 'type'=>'boolean', 'data' => 'str', 'help'=>''),        
      'link_cat_desc'		=> array('title'=> LCLAN_OPT_15, 'tab'=>3, 'type'=>'boolean', 'data' => 'str', 'help'=>''),        
      'link_cat_amount'		=> array('title'=> LCLAN_OPT_16, 'tab'=>3, 'type'=>'boolean', 'data' => 'str', 'help'=>''),        
      'link_cat_total'		=> array('title'=> LCLAN_OPT_19, 'tab'=>3, 'type'=>'boolean', 'data' => 'str', 'help'=>''),        
      'link_cat_empty'		=> array('title'=> LCLAN_OPT_65, 'tab'=>3, 'type'=>'boolean', 'data' => 'str', 'help'=>''),        
      'link_cat_icon_empty'		=> array('title'=> LCLAN_OPT_22, 'tab'=>3, 'type'=>'boolean', 'data' => 'str', 'help'=>''),        
      'link_cat_sortorder'		=> array('title'=> LCLAN_OPT_29, 'tab'=>3, 'type'=>'boolean', 'data' => 'str', 'help'=>''),        
      'link_cat_sort'		=> array('title'=> LCLAN_OPT_24, 'tab'=>3, 'type'=>'dropdown', 'data' => 'str', 'help'=>''),       
      'link_cat_order'		=> array('title'=> LCLAN_OPT_23, 'tab'=>3, 'type'=>'dropdown', 'data' => 'str', 'help'=>''),        
      'link_cat_resize_value'		=> array('title'=> LCLAN_OPT_25, 'tab'=>3, 'type'=>'text', 'data' => 'str', 'help'=>''),         
  
      'link_icon'		=> array('title'=> LCLAN_OPT_14, 'tab'=>4, 'type'=>'boolean', 'data' => 'str', 'help'=>''),
      'link_referal'		=> array('title'=> LCLAN_OPT_17, 'tab'=>4, 'type'=>'boolean', 'data' => 'str', 'help'=>''),
      'link_url'		=> array('title'=> LCLAN_OPT_18, 'tab'=>4, 'type'=>'boolean', 'data' => 'str', 'help'=>''),
      'link_desc'		=> array('title'=> LCLAN_OPT_15, 'tab'=>4, 'type'=>'boolean', 'data' => 'str', 'help'=>''),
      'link_sortorder'		=> array('title'=> LCLAN_OPT_29, 'tab'=>4, 'type'=>'boolean', 'data' => 'str', 'help'=>''),        
      'link_sort'		=> array('title'=> LCLAN_OPT_24, 'tab'=>4, 'type'=>'dropdown', 'data' => 'str', 'help'=>''),       
      'link_order'		=> array('title'=> LCLAN_OPT_23, 'tab'=>4, 'type'=>'dropdown', 'data' => 'str', 'help'=>''),
         //????  0=same window, 1=_blank, 2=_parent, 3=_top, 4=miniwindow
      'link_open_all'		=> array('title'=> LCLAN_OPT_32, 'tab'=>4, 'type'=>'dropdown', 'data' => 'str', 'help'=>''),
      'link_cat_resize_value'		=> array('title'=> LCLAN_OPT_33, 'tab'=>4, 'type'=>'text', 'data' => 'str', 'help'=>''),        
       

      'link_refer_minimum'		=> array('title'=> LCLAN_OPT_56, 'tab'=>5, 'type'=>'text', 'data' => 'str', 
        'help'=>LCLAN_OPT_64),  
          
			'link_rating'		=> array('title'=> LCLAN_OPT_27, 'tab'=>6,'type'=>'boolean','data' => 'str', 'help'=>''),           
...
class links_submitted_ui extends e_admin_ui
{
		...
		protected $pluginTitle	= LCLAN_PLUGIN_LAN_1;
		protected $pluginName		= 'links_page';
		protected $eventName		= 'links_page-links_page_submitted';  		
		protected $table			= 'links_page';
		protected $pid				= 'link_id';
		protected $perPage			= 10; 
		protected $batchDelete		= true;
