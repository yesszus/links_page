...
if(isset($linkspage_pref['link_menu_navigator_links']) && $linkspage_pref['link_menu_navigator_links']){
	if(isset($linkspage_pref['link_menu_navigator_rendertype']) && $linkspage_pref['link_menu_navigator_rendertype'] == "1"){
		...
		$mains .= $bullet." <a href='".e107::url('links_page', 'alllinks')."'>".LAN_LINKS_51."</a><br />";
	}
}
...
if(isset($linkspage_pref['link_menu_navigator_manager']) && $linkspage_pref['link_menu_navigator_manager'] && isset($linkspage_pref['link_manager']) && $linkspage_pref['link_manager'] && check_class($linkspage_pref['link_manager_class'])){
	if(isset($linkspage_pref['link_menu_navigator_rendertype']) && $linkspage_pref['link_menu_navigator_rendertype'] == "1"){
		$mains .= $rs -> form_option(LCLAN_SL_12, "0", e107::url('links_page', 'manage'), "");
	}else{
		$mains .= $bullet." <a href='".e107::url('links_page', 'manage')."'>".LCLAN_SL_12."</a><br />";
	}
}

if($mains){
	$cap = (isset($linkspage_pref['link_menu_navigator_caption']) && $linkspage_pref['link_menu_navigator_caption'] ? $linkspage_pref['link_menu_navigator_caption'] : LAN_LINKS_60);
	if(isset($linkspage_pref['link_menu_navigator_rendertype']) && $linkspage_pref['link_menu_navigator_rendertype'] == "1"){
...
if(isset($linkspage_pref['link_menu_category']) && $linkspage_pref['link_menu_category']){
	$mains = "";
	$cap = (isset($linkspage_pref['link_menu_category_caption']) && $linkspage_pref['link_menu_category_caption'] ? $linkspage_pref['link_menu_category_caption'] : LAN_LINKS_43);
