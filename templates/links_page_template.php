...
$LINKS_PAGE_TEMPLATE['LINK_TABLE_CAPTION'] = LAN_LINKS_39;
...
$LINKS_PAGE_TEMPLATE['LINK_SUBMIT_TABLE'] = "
    ...
    <div class='form-group'> <label for='cat_id' class='col-sm-2 control-label'><span class='required'>*&nbsp;</span>".LAN_LINKS_57."</label>
      <div class='col-sm-10'>{LINK_SUBMIT_NAME}</div>
    </div>
    <div class='form-group'> <label for='link_url' class='col-sm-2 control-label'><span class='required'>*&nbsp;</span>".LAN_LINKS_58."</label>
      <div class='col-sm-10'>{LINK_SUBMIT_URL}</div>
    </div>          
    <div class='form-group'> <label for='link_description' class='col-sm-2 control-label'><span class='required'>*&nbsp;</span>".LAN_LINKS_59."</label>
      <div class='col-sm-10'>{LINK_SUBMIT_DESCRIPTION}</div>
    </div>
    <div class='form-group'> <label for='link_button' class='col-sm-2 control-label'>".LAN_LINKS_53."</label>
